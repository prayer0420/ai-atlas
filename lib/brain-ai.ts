  ...
  if (localMode()) {
    ...
    const concise =
      name === "daily_cards"
        ...
        : name === "knowledge_wiki"
          ? " 일반 정리는 서로 연결된 문서 정확히 2개, 질문 답변은 정확히 1개를 작성하세요. 각 body는 800~1400자의 깊이 있는 설명으로 구성하고 summary는 한 문장으로 작성하세요. 원문이나 기존 AI 학습 노트의 주장은 독립적으로 검증된 사실이 아닙니다. 특정 회사의 실제 적용 여부, 성능, 검출 성공률은 '자료에서는 ...라고 설명한다'처럼 출처에 귀속하세요. 통계적 검출은 확정적 증명이 아니며 가상 예시나 비유를 실제 동작으로 단정하지 마세요. 보충 사례는 가상 예시로 표시하고 실제 제품 사양을 만들지 마세요. 불확실성과 발췌·요약의 한계는 caveats에 반드시 남기세요."
          : "";
